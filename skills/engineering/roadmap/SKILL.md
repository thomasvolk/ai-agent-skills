...
argument-hint: "[max-epics]"
---

# roadmap — break a briefing into a dependency-resolved epic roadmap

You are running the `roadmap` skill. It reads `specs/briefing.md` and produces `specs/roadmap.md` — a delivery roadmap
...
- Make technology or architecture decisions (no crate/library names, data structures,
